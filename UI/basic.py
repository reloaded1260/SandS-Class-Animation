...
class MainWindow(wx.Frame):
    ...
    def __init__(self, parent, title):
        ...
        # 创建菜单栏
        menuBar = wx.MenuBar()
        menuBar.Append(filemenu, "&文件")  # 在菜单栏中添加filemenu菜单
    ...
    def OnAbout(self, e):
        ...
        dlg = wx.MessageDialog(self, "此程序为信号与系统课程动画软件",
                               "关于此程序", wx.OK)  # 语法是(self, 内容, 标题, ID)
        dlg.ShowModal()  # 显示对话框
...
app = wx.App(False)
frame = MainWindow(None, title="信号与系统课程动画软件系统")
app.MainLoop()
